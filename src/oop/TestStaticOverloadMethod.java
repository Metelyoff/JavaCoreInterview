...
class B extends A {
	// public void test(){} - This instance method cannot override the static
	// method from A
	// public static void test(String test){} This static method cannot hide the
...
public class TestStaticOverloadMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println("-----------");
		// B ba=(B)new A(); - java.lang.ClassCastException: oop.A cannot be cast
		// to oop.B
	}
}
